 ...
 * 
 */
@WebServiceClient(name = "Servicios", targetNamespace = "http://WerService/", wsdlLocation = "http://localhost:30777/ServicioCrud/Servicios?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOS_QNAME = new QName("http://WerService/", "Servicios");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:30777/ServicioCrud/Servicios?wsdl");
    ...
    public Servicios getServiciosPort() {
        return super.getPort(new QName("http://WerService/", "ServiciosPort"), Servicios.class);
    }
    ...
    public Servicios getServiciosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WerService/", "ServiciosPort"), Servicios.class, features);
    }
